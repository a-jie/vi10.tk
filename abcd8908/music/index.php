...
/*if(!isset($_COOKIE['token'])){
    ...
    $response = json_decode(file_get_contents('https://api.vitasha.tk/music/news/'.$_COOKIE['token']), true);
    if($response['status']){
        //Auth true
    }else{
        header("Location: login.php");
...
<body>
    ...
    <script>
        ...
        function search_history_show(){
            $.ajax({
                type: "GET",
                url: "https://api.vitasha.tk/music/search_history/8908/",
                dataType: 'text',
        ...
        function add_to_playlist(name, author, id, cover, cover_xl, explicit){
            ...
            $.ajax({
                type: "GET",
                url: "https://api.vitasha.tk/music/playlist_add_track/8908/?playlist_name="+playlist_name+"&name="+name+"&author="+author+"&id="+id+"&cover="+cover+"&cover_xl="+cover_xl+"&explicit="+explicit,
                dataType: 'text',
                success: function(data){
                    alert('Success');
                }
        ...
        async function my(){
            $.ajax({
                type: "GET",
                url: "https://api.vitasha.tk/music/playlists_get/8908/",
                dataType: 'text',
                success: function(data){
                    var array = JSON.parse(data);
                    $('#my').empty();
        ...
        function playlist_open(name_1){
            $.ajax({
                type: "GET",
                url: "https://api.vitasha.tk/music/playlist_get_tracks/8908/?playlist_name="+name_1,
                dataType: 'text',
                success: function(data){
                    var array = JSON.parse(data);
                    $('#my').empty();
